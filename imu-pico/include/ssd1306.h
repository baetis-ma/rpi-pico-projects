static int ssd1306_init()
{
    ...
    i2c_write_blocking( i2c1, SSD1306_I2C_ADDR, data, 26, false);
    printf("i2c init\n");
    return(0);
}
...
static int ssd1306_blank(uint8_t val)
{
   ...
   i2c_write_blocking( i2c1, SSD1306_I2C_ADDR, data, len/2, false);
   free(data);
   return(0);
}
...
static int ssd1306_text( char *disp_string )
{
   ...
   i2c_write_blocking( i2c1, SSD1306_I2C_ADDR, data, len/2+1, false);
   free(framebuffer);
   free(data);
   return(0);
}
